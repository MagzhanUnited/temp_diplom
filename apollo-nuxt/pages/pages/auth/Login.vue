...
const login = async () => {
    const response = await ResidentService.login(credentials.value);
        ...
        <div class="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
            ...
            <div class="flex flex-column">
                <span class="p-input-icon-left w-full mb-4">
                    ...
                    <InputText id="email" v-model="credentials.email" type="text" class="w-full md:w-25rem" placeholder="Email" />
                </span>
                <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-lock"></i>
                    <InputText id="password" v-model="credentials.password" type="password" class="w-full md:w-25rem" placeholder="Password" />
                </span>
