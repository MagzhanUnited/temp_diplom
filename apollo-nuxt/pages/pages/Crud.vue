        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column header="Image" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <img :src="'http://10.255.184.3:2002/static/' + slotProps.data.thumbnail[0]" :alt="slotProps.data.thumbnail[0]" class="shadow-2" width="100" />
                        </template>
                    </Column>
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                    <img :src="'http://10.255.184.3:2002/static/' + product.thumbnail[0]" :alt="product.thumbnail[0]" v-if="product.thumbnail" width="150" class="mt-0 mx-auto mb-5 block shadow-2" />
                    <!-- <FileUpload v-else mode="basic" name="demo[]" url="http://10.255.184.3:2002/upload" accept="image/*" :maxFileSize="1000000" customUpload @uploader="customBase64Uploader" style="margin-top: 2dvh; margin-bottom: 2dvh" /> -->
                    <FileUpload v-else mode="advanced" name="demo[]" url="http://10.255.184.3:2002/upload" :showUploadButton="false" :multiple="true" ref="fileUpload" accept="image/*" :maxFileSize="10000000" @uploader="customBase64Uploader">
                        <template #empty>
                    ...
                    <!-- <FileUpload v-if="!product.thumbnail" mode="advanced" name="demo[]" url="http://10.255.184.3:2002/upload" :showUploadButton="false" :multiple="true" ref="fileUpload" accept="image/*" :maxFileSize="10000000" @upload="onUpload">
                        <template #empty>
                    ...
                    <FileUpload
                        ...
                        mode="advanced"
                        name="demo[]"
                        url="http://10.255.184.3:2002/upload"
