<template>
    <div class="card docs">
        ...
        <p>Next step is running the application using the serve script and navigate to <i>http://194.4.58.178:3000/</i> to view the application. That is it, you may now start with the development using the Apollo template.</p>
